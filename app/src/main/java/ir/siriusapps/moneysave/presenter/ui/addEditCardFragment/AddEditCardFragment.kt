    ...
    override fun onCreateView(
        ...
        binding = FragmentAddEditCardBinding.inflate(inflater, container, false).apply {
          ...
          //cardView.cardColor = ContextCompat.getColor(requireContext(), R.color.color_cardBlack)
            ...
            grayButton.setOnClickListener{cardView.cardColor =ContextCompat.getColor(requireContext(), R.color.color_gray)}
            greenButton.setOnClickListener{cardView.cardColor = ContextCompat.getColor(requireContext(),R.color.color_Green)}
            blueButton.setOnClickListener{cardView.cardColor =ContextCompat.getColor(requireContext(), R.color.color_blue)}
            purpleButton.setOnClickListener{cardView.cardColor =ContextCompat.getColor(requireContext(), R.color.color_purple)}
            pinkButton.setOnClickListener{cardView.cardColor = ContextCompat.getColor(requireContext(),R.color.color_pink)}

            wingSmallImage.setOnClickListener{cardView.backgroundImage=ContextCompat.getDrawable(requireContext(),R.drawable.cb_wing)}
            birdSmallImage.setOnClickListener{cardView.backgroundImage=ContextCompat.getDrawable(requireContext(),R.drawable.cb_bird)}
            flowerSmallImage.setOnClickListener{cardView.backgroundImage=ContextCompat.getDrawable(requireContext(),R.drawable.cb_flower)}
            abstractSmallImage.setOnClickListener{cardView.backgroundImage=ContextCompat.getDrawable(requireContext(),R.drawable.cb_abstract)}

            createButton.setOnClickListener{Navigation.findNavController(this.root)
